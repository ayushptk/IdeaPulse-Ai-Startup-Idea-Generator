      ...
      <div className="w-full lg:w-[45%] flex flex-col h-full px-8 sm:px-12 lg:px-16 py-6">
        ...
        <div className="flex-1 flex flex-col justify-center">
          <div className="w-full max-w-[420px]">
            ...
            <h1 className="text-3xl font-bold text-[#0D0D0D] mb-1 tracking-tight">Create an Account</h1>
            <p className="text-[#6B7280] text-sm font-medium mb-5">Enter your details below to get started</p>
        ...
        <p className="text-[13px] text-[#6B7280] font-medium text-center shrink-0">
          ...
          <Link href="/login" className="text-[#FB611E] font-bold hover:underline">Log In</Link>
        </p>
      </div>
